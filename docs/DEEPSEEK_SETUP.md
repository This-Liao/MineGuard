...
客户端与流水线已经通过本机 HTTP 桩测试，并于 2026-08-31 实际完成 DeepSeek 评测。2026-09-13 又通过 LangChain4j 1.20 AI Services 完成 24 条专项回归：30/30 请求取得 HTTP 200、类型化解析和 Token 回执，Agent 严格成功 21/24，共 65,027 Token，见 [专项报告](LANGCHAIN4J_EVAL.md)。脚本保留每次运行的保护额度；此前 1 次只读冒烟记录继续独立归档。
